...
export default function ProductCard({ product, onAddToCart, onViewDetails }: ProductCardProps) {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden bg-gray-50 mb-4 cursor-pointer" onClick={() => onAddToCart(product)}>
        <img
          src={displayImage}
          alt={product.name}
      ...
      <div className="text-center">
        <h3 className="text-sm font-medium tracking-wide text-[#0d2818] mb-1">{product.name}</h3>
